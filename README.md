...
The **Heading Hover Breadcrumb** main-settings section provides these controls. Subordinate controls become inaccessible whenever a required parent is off; stored values are retained.
